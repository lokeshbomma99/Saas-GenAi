...
import { Edit, Hash, Sparkle, Sparkles, Image } from 'lucide-react';
      ...
      >
        ...
        <div className="my-6 flex items-center gap-2">
          <label className="relative cursor-pointer">
            ...
            <div className="relative w-9 h-5 bg-slate-300 rounded-full peer-checked:bg-green-500 transition "></div>
