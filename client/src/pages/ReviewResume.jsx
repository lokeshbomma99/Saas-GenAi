...
//           className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3]
...
//             <p>Upload an resume and click "Resume Resume" to get started </p>
//           </div>
//         </div>
//     ) :(
